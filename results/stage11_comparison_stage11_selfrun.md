...
Tag: stage11_selfrun
Generated (UTC): 2026-04-05T22:56:49.685232+00:00
...
- Protected-flow throughput under congestion changed from 4.613 Mbps to 5.451 Mbps.
- Packet delivery under congestion changed from 100.0% to 100.0%.
- Average latency under congestion changed from 5.664 ms to 5.826 ms.
...
| Throughput (Mbps) | 4.613 | 5.451 | 0.838 |
| Packet loss (%) | 0.0 | 0.0 | 0.0 |
| Packet delivery (%) | 100.0 | 100.0 | 0.0 |
| Avg latency (ms) | 5.664 | 5.826 | 0.162 |
...
## Evidence Summary
- Throughput gain under congestion: 0.838 Mbps.
- Packet delivery gain under congestion: 0.0 percentage points.
- Packet loss reduction under congestion: 0.0 percentage points.
- Latency reduction under congestion: -0.162 ms.
- Adaptive congestion response time: 0.001 s.
- Adaptive reroute observed: yes.

## Artifacts
- Before (JSON): /home/patrick/mininet/results/adaptive_eval_stage11_selfrun_static.json
- After (JSON): /home/patrick/mininet/results/adaptive_eval_stage11_selfrun_adaptive.json
- Comparison (JSON): /home/patrick/mininet/results/stage11_comparison_stage11_selfrun.json
- Comparison (CSV): /home/patrick/mininet/results/stage11_comparison_stage11_selfrun.csv
- Comparison (Markdown): /home/patrick/mininet/results/stage11_comparison_stage11_selfrun.md
