...
Tag: 20260405_230908
Generated (UTC): 2026-04-05T21:10:54.422215+00:00
...
- Protected-flow throughput under congestion changed from 4.403 Mbps to 5.451 Mbps.
- Packet delivery under congestion changed from 100.0% to 100.0%.
- Average latency under congestion changed from 5.5 ms to 5.606 ms.
...
| Throughput (Mbps) | 4.403 | 5.451 | 1.048 |
| Packet loss (%) | 0.0 | 0.0 | 0.0 |
| Packet delivery (%) | 100.0 | 100.0 | 0.0 |
| Avg latency (ms) | 5.5 | 5.606 | 0.106 |
...
## Evidence Summary
- Throughput gain under congestion: 1.048 Mbps.
- Packet delivery gain under congestion: 0.0 percentage points.
- Packet loss reduction under congestion: 0.0 percentage points.
- Latency reduction under congestion: -0.106 ms.
- Adaptive congestion response time: n/a s.
- Adaptive reroute observed: yes.

## Artifacts
- Before (JSON): /home/patrick/mininet/results/adaptive_eval_20260405_230908_static.json
- After (JSON): /home/patrick/mininet/results/adaptive_eval_20260405_230908_adaptive.json
- Comparison (JSON): /home/patrick/mininet/results/stage11_comparison_20260405_230908.json
- Comparison (CSV): /home/patrick/mininet/results/stage11_comparison_20260405_230908.csv
- Comparison (Markdown): /home/patrick/mininet/results/stage11_comparison_20260405_230908.md
