...
ML_ACTION_FILE="${CAMPUS_ML_ACTION_FILE:-/tmp/stage4_ml_action.json}"
MANUAL_SETTINGS_FILE="${CAMPUS_MANUAL_SETTINGS_FILE:-/tmp/stage4_manual_settings.json}"
SECURITY_POLICY_FILE="${CAMPUS_SECURITY_POLICY_FILE:-/tmp/stage4_security_policy.json}"
NETWORK_AUTOMATION_FILE="${CAMPUS_NETWORK_AUTOMATION_FILE:-/tmp/stage4_network_automation.json}"
PW="${SUDO_PASSWORD:-}"
